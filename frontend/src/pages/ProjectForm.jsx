...
import { createProjectRequest } from '../api/index.js';
...
export default function ProjectForm() {
  ...
  const isOnlyDoc = form.projectType === 'only-documentation';
  const hasOwnTopic = !!form.ownProjectTopic;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({
        name: '', college: '', course: '', email: '', mobile: '',
        chooseProject: '', ownProjectTopic: '', projectType: 'with-documentation', description: '',
      });
      navigate('/');
    } catch (err) {
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6" data-aos="fade-up">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    disabled={hasOwnTopic}
                    className="w-full bg-medium border border-light/10 px-4 py-3 text-light focus:border-teal focus:outline-none transition-colors disabled:opacity-40 disabled:cursor-not-allowed appearance-none"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={isOnlyDoc}
                    className="w-full bg-medium border border-light/10 px-4 py-3 text-light placeholder-light/20 focus:border-teal focus:outline-none transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            ...
            <button type="submit" disabled={sending} className="w-full bg-teal text-dark py-4 font-black uppercase tracking-tight hover:bg-light transition-all duration-300 disabled:opacity-50">
